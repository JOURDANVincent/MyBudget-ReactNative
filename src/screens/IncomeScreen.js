...
function IncomeScreen( props ){
    ...
    return (
        ...
        <View style={ styles.container }>
            ...
            <Text style={{ width: '100%', color: '#aa1010', fontSize: 22, fontWeight: 'bold', paddingLeft: 5, marginBottom: 10, textAlign: 'left'}}>Nouveau revenu</Text>
            ...
            <View style={styles.viewBox}>
                ...
                <Controller
                    ...
                    defaultValue=""
                />
                {errors.firstName && <Text style={{ color: 'red', }}>* champ requis..</Text>}
            </View>
            ...
            <View style={styles.viewBox}>
                ...
                <Controller
                    ...
                    defaultValue=""
                />
                {errors.lastName && <Text style={{ color: 'red', }}>* champ requis..</Text>}
            </View>
            ...
            <View style={styles.viewBox}>
                ...
                <Controller
                    ...
                    defaultValue=""
                />
                {errors.amount && <Text style={{ color: 'red', }}>* champ requis..</Text>}
            </View>
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, category } }) => (
                            <Picker
                                ...
                                <Picker.Item label="salaire et assimilé" value="1" />
                                <Picker.Item label="revenu financier" value="2" />
            ...
            <View style={[styles.viewBox, {minHeight: 100 }]}>
                ...
                <Controller
                    ...
                    defaultValue=""
                />
                {errors.comment && <Text style={{ color: 'red', }}>* champ requis..</Text>}
            </View>
